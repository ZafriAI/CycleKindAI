...
export default function Ask() {
  ...
  return (
    <View style={{ padding:16, gap:10, flex:1 }}>
      ...
      <Text>Question</Text>
      <TextInput value={question} onChangeText={setQuestion} style={{ borderWidth:1, padding:10, borderRadius:10 }} />
      <Text>k</Text>
      <TextInput value={k} onChangeText={setK} keyboardType="numeric" style={{ borderWidth:1, padding:10, borderRadius:10, width:100 }} />
      ...
      {sources.length > 0 && (
        <>
          ...
          <FlatList data={sources} keyExtractor={(_, i) => String(i)} renderItem={({ item }) =>
